  ...
  var AppView = _react2.default.createClass({
    ...
    render: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement("img", { className: "logo", src: "http://i.imgur.com/iIdqZyR.png?1" }),
  ...
  var Console = _react2.default.createClass({
    ...
    _forward: function _forward() {
      if (!this.state.ticking) {
        var forwardYear = function forwardYear() {
          this.setState({
    ...
    _rewind: function _rewind() {
      if (!this.state.ticking) {
        var rewindYear = function rewindYear() {
          this.setState({
            year: this.state.year - 1,
            rewindSymbol: "⏸",
            ticking: true
    ...
    render: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "button",
            { className: "rewindButton", onClick: this._rewind },
            this.state.rewindSymbol
          ),
          this.state.year,
          _react2.default.createElement(
            "button",
            { className: "forwardButton", onClick: this._forward },
            this.state.forwardSymbol
          )
        )
      );
    }
